...
namespace WinFormsApp4
{
    public partial class ToastForm : Form
    {
        ...
        private static System.Drawing.Drawing2D.GraphicsPath GetRoundedRectPath(float x, float y, float width, float height, float radius)
        {
            ...
            path.AddArc(x + width - radius, y, radius, radius, 270, 90); // Top-right corner
            path.AddArc(x + width - radius, y + height - radius, radius, radius, 0, 90); // Bottom-right corner
            path.AddArc(x, y + height - radius, radius, radius, 90, 90); // Bottom-left corner
